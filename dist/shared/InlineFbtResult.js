...
function (_FbtResultBaseImpl) {
  _inherits(InlineFbtResult, _FbtResultBaseImpl);
  ...
  function InlineFbtResult(contents, inlineMode, translation, hash) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(InlineFbtResult).call(this, contents));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "type", InlineFbtComponent);
