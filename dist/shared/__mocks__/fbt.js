 ...
 */
jest.unmock('substituteTokens').unmock('intlNumUtils').unmock('IntlPunctuation').unmock('IntlPhonologicalRewrites').unmock('NumberFormatConsts').unmock('IntlVariationResolver').unmock('IntlVariationResolverImpl').unmock('FbtTableAccessor').mock('FbtNumberType');
var fbt = jest.fn();
...
fbt._.mockImplementation(function (wrappedJSON, args) {
  var unwrappedJson = unwrap(wrappedJSON);
  var jsfbt = unwrappedJson.jsfbt;
